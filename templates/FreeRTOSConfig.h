...
#define configTOTAL_HEAP_SIZE     ( ( size_t ) ( 115 * 1024 ) ) /* 2 iperf instances need 68KB to run on AP mode */
#else
...
/* for nvram task */
#define NVRAM_TASK_NAME "nvram"
#define NVRAM_TASK_STACKSIZE 512
#define NVRAM_TASK_PRIO 2
#define MAX_NVRAM_QUEUES     16
