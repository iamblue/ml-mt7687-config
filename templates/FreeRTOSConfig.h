...
#define configTOTAL_HEAP_SIZE           ( ( size_t ) ( <%= TOTAL_HEAP_SIZE %> * 1024 ) ) /* 2 iperf instances need 68KB to run on AP mode */
#else
#define configTOTAL_HEAP_SIZE           ( ( size_t ) ( <%= TOTAL_HEAP_SIZE %> * 1024 ) ) /* 2 iperf instances need 68KB to run on AP mode */
#endif
#endif
...
//Guofu: disable tickless for now, it causes the wifi connection fail
